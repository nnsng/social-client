...
interface MUISwitchProps extends UseSwitchProps {
  onSwitchChange?: (checked: boolean) => void;
}

function MUISwitch({ onSwitchChange, ...props }: MUISwitchProps) {
...
interface ThemeSwitchProps {
  onChange?: (themeMode: PaletteMode) => void;
}
...
export default function ThemeSwitch({ onChange }: ThemeSwitchProps) {
  ...
  return <MUISwitch defaultChecked={themeMode === 'dark'} onSwitchChange={handleSwitchChange} />;
}
